...
def generate_metadata_single_image(image_front_path,image_processor,image_description_model,metadata_exporter,csv_file,token_tracker):
    ...
    #reset token counting mechanisms for each model

def generate_metadata_front_and_back(image_front_path,image_back_path,image_processor,transcription_model,image_description_model,metadata_exporter,csv_file):
    image_front = image_processor.process_image(image_front_path)
...
generate_metadata_front_and_back(image_front_path,image_back_path,image_processor,transcription_model,image_description_model,metadata_exporter,result_double_csv)
#generate_metadata_single_image(image_front_path,image_processor,image_description_model,metadata_exporter,result_single_csv)
